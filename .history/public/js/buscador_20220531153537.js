    ...
    if( textoBuscador.replace(/ /g, "")==""){
        ...
        $.ajax({
            ...
            beforeSend: function ( xhr ) {
                ...
                $('.containerBuscandoUser').html('<div class="buscandoUser"><div class="containerBuscandoUser"><div class="gifBuscandoDIV"><img src="../../uploads/img/ajax-loader.gif" id="gifBuscando"/></div><div class="textoBuscando">Buscando "'.textoBuscador.'"...</div></div</div>'); 
